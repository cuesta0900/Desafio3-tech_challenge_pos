...
FROM state_of_data_gold_v2.q2_senioridade_salario
...
FROM state_of_data_gold_v2.q3_genero_por_ano
...
FROM state_of_data_gold_v2.q4_linguagens_por_ano
WHERE ano_pesquisa = 2025
ORDER BY qtd DESC
LIMIT 10;
...
SELECT
    ...
    "count" AS qtd,
    ROUND(100.0 * "count" / SUM("count") OVER (PARTITION BY ano_pesquisa), 1) AS pct_no_ano
FROM state_of_data_gold_v2.q5_ia_por_ano
ORDER BY ano_pesquisa, pct_no_ano DESC;
